...
<body>
    <form action="Search.php" method="get" enctype="">
        ...
        <script>
            function validate() {
                let Search = document.getElementById("leaving").value;
